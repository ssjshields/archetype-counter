...
if ($Script:CounterMode -match "Collapsed_Fossil") { $Script:ArchetypeFossilLabelCount.Location = New-object system.drawing.point(44,12); $Script:ArchetypeFossilLabelCount.Visible = $true }
...
if ($Script:CounterMode -match "Collapsed_Egg") { $Script:ArchetypeEggLabelCount.Location = New-object system.drawing.point(44,12) }
...
if ($Script:CounterMode -match "Collapsed_Encounter") { $Script:ArchetypeCollapsedCount.Location = New-object system.drawing.point(44,12) }
