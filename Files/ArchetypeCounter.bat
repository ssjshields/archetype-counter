        ...
        Do {
                ...
                if ($PokeMMOActive -ne $null) {
                    ...
                    if (($GetPixelColor -match '\b('+($PixelMatchArray -join '|')+')\b')) { 
                        ...
                        #$PokemonD = $PokemonD -Replace '[^0-9]','' -Replace ' ', ''; $PokemonE = $PokemonE -Replace '[^0-9]','' -Replace ' ', ''; $PokemonF = $PokemonF -Replace '[^0-9]','' -Replace ' ', ''; $PokemonG = $PokemonG -Replace '[^0-9]','' -Replace ' ', ''; $PokemonH = $PokemonH -Replace '[^0-9]','' -Replace ' ', ''; $PokemonI = $PokemonI -Replace '[^0-9]','' -Replace ' ', ''; $PokemonJ = $PokemonJ -Replace '[^0-9]','' -Replace ' ', ''
